...
$sql="select * from users where emailid=$ketan";
	$qr=mysql_query($sql);
...
<input type="button" value="Friends" name="friends" style="font:Verdana, Geneva, sans-serif; font-size:18px; border-bottom-style:solid;border-color:#FF9933; width:90px; height:30px; background-color:#CCC; color:#000">

<img src="VR2.jpg" width="75%" height="8"><br>

<input type="button" value="Public" name="freezone" style="font:Verdana, Geneva, sans-serif; font-size:18px; border-bottom-style:solid;border-color:#FF9933; width:90px; height:30px; background-color:#CCC; color:#000">
...
<textarea cols="100" rows="7" placeholder="write something new....."></textarea>

<table width="85%" border="0"><tr><td align="right">
